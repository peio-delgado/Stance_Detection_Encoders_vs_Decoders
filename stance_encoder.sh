...
#SBATCH --mem=16GB
#SBATCH --gres=gpu:1
#SBATCH --output=/home/pdelgado010/stance_project/stance_encoder.log
#SBATCH --error=/home/pdelgado010/stance_project/stance_encoder.err
